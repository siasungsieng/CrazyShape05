...
import kotlinx.android.synthetic.main.activity_game_acitivity05.*
import org.tensorflow.lite.support.image.TensorImage
import tw.edu.pu.o10830270.crazyshape05.ml.Shapes

class GameAcitivity05 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_game_acitivity05)
